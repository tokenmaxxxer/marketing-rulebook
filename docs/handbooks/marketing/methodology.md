...
Kill switch: `MARKETING_MESSAGING_GATE_OFF=1`.
...
4. **Owned/earned/paid** classification given.
...
Kill switch: `MARKETING_CHANNEL_GATE_OFF=1`.
...
Kill switch: `MARKETING_SEGMENT_GATE_OFF=1`.
